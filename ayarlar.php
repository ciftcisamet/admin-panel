                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="forms-sample">
                                            ...
                                            <div class="form-group">
                                                    <label for="">Bir Kategori Seçimi Yapın</label>
                                                    <select class="form-control select2">
                                                        <option value="cheese">Arabesk</option>
                                                        <option value="tomatoes">Rock</option>
                                                        <option value="mozarella">Halk Müziği</option>
                                                    </select>
                                                </div>
